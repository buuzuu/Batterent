...
public class StartPaymentActivity extends AppCompatActivity {
    ...
    private static final String TAG = "StartPaymentActivity";

//    String TAG ="mainActivity", txnid ="txt12346", amount ="20", phone ="7668479477",
//            prodname ="BlueApp Course", firstname ="Hritik", email ="hritikgupta722@gmail.com",
//            merchantId ="5884494", merchantkey="vAMuBpEx";  //   first test key only
    String phone,amount,txnid,prodname,firstname,email,merchantkey,merchantId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProgressLoadingJIGB.startLoadingJIGB(StartPaymentActivity.this,R.raw.pork_dance,"Connecting to payment Gateway...",0,800,800);

        Intent intent = getIntent();
        phone = intent.getExtras().getString("phone");
        amount = intent.getExtras().getString("amount");
        txnid = intent.getExtras().getString("orderId");
        prodname = intent.getExtras().getString("model");
        ...
        if (phone!=null && amount!=null && txnid!=null && prodname!=null && email!=null && firstname!=null ) {
            ...
            Toast.makeText(this, "Can't get data from Intent.", Toast.LENGTH_SHORT).show();
        }
    }
...
// on successfull txn
        ...
        if (requestCode == PayUmoneyFlowManager.REQUEST_CODE_PAYMENT && resultCode == RESULT_OK && data != null) {
            ...
            if (transactionResponse != null && transactionResponse.getPayuResponse() != null) {
                ...
                if(transactionResponse.getTransactionStatus().equals( TransactionResponse.TransactionStatus.SUCCESSFUL )){
                    ...
                    putDataOnCloud();
                    //Success Transaction
                    ToastUtils.showLong(StartPaymentActivity.this,"Successful",true);
                    startActivity(new Intent(StartPaymentActivity.this,HomeActivity.class));
                    finish();
    ...
    private void putDataOnCloud() {

        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                reference.child(txnid).setValue(Common.myOrder);
