...
import com.example.batterent.Interface.ServiceInterface;
...
public class ServiceWrapper {
    ...
    public Retrofit getRetrofit(Interceptor mInterceptorheader) {
        ...
        builder.connectTimeout(Common.API_CONNECTION_TIMEOUT, TimeUnit.SECONDS);
        builder.readTimeout(Common.API_READ_TIMEOUT, TimeUnit.SECONDS);
